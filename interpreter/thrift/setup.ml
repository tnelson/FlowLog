...
(* OASIS_START *)
(* DO NOT EDIT (digest: 78a3b5e9b140c3873bfd6b3081798a0f) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "placeholder.ml"})
            ];
          plugins =
     ...
     oasis_version = "0.4.4";
     oasis_digest =
       Some "\202\146\144j\207g)\155\146\221\239\164p\014\199\223";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
