...
(* OASIS_START *)
(* DO NOT EDIT (digest: 3284d05b8c837241a570afd9388ad3dd) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "http://cs.wpi.edu/~tn";
            ...
            [
               Library
                 ({
                      ...
                      },
                   {
                      ...
                      lib_findlib_name = Some "flowlog_thrift";
                 ...
                 ({
                     ...
                     },
                   {
                      ...
                      bs_build_depends =
                        [
                           FindlibPackage ("thrift", None);
                           InternalLibrary "flowlog_thrift";
                           FindlibPackage ("threads", None)
                        ];
                   ...
                   {exec_custom = false; exec_main_is = "o2warning.ml"; });
               Executable
                 ({
                     cs_name = "notify";
                     cs_data = PropList.Data.create ();
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "timer.ml"; });
               Executable
                 ({
                     cs_name = "Police_Tipline";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = [];
                     },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "police_tipline.ml"; 
                   })
            ];
          plugins =
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "\208}\254T7\003\151\184\000\161\137\158P\1643|";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
