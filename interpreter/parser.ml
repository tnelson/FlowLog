...
# 54 "parser.mly"
        ...
        Program(_2, imports, blackboxes, types, clauses) )
# 229 "../parser.ml"
               : program))
; (fun __caml_parser_env ->
...
; (fun __caml_parser_env ->
    ...
    Obj.repr(
# 88 "parser.mly"
                                                                         ( Clause(Plus, String.lowercase _2, _4, _7) )
# 351 "../parser.ml"
               : clause))
; (fun __caml_parser_env ->
    let _2 = (Parsing.peek_val __caml_parser_env 6 : string) in
    ...
    Obj.repr(
# 89 "parser.mly"
                                                                          ( Clause(Minus, String.lowercase _2, _4, _7) )
# 360 "../parser.ml"
               : clause))
; (fun __caml_parser_env ->
    let _2 = (Parsing.peek_val __caml_parser_env 6 : string) in
    ...
    Obj.repr(
# 90 "parser.mly"
                                                                          ( Clause(State, String.lowercase _2, _4, _7) )
# 369 "../parser.ml"
               : clause))
; (fun __caml_parser_env ->
    let _2 = (Parsing.peek_val __caml_parser_env 5 : string) in
    ...
    Obj.repr(
# 91 "parser.mly"
                                                                ( Clause(State, String.lowercase _2, [], _6) )
# 377 "../parser.ml"
               : clause))
; (fun __caml_parser_env ->
    let _2 = (Parsing.peek_val __caml_parser_env 6 : string) in
    ...
    Obj.repr(
# 92 "parser.mly"
                                                                           ( Clause(Action, String.lowercase _2, _4 ,_7) )
# 386 "../parser.ml"
               : clause))
; (fun __caml_parser_env ->
...
; (fun __caml_parser_env ->
    ...
    Obj.repr(
# 103 "parser.mly"
                      ( Notiv_var(String.uppercase _1, String.uppercase _3) )
# 438 "../parser.ml"
               : term))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 2 : term) in
...
; (fun __caml_parser_env ->
    ...
    Obj.repr(
# 108 "parser.mly"
                                   ( Apply(Pos, "", String.lowercase _1, _3) )
# 462 "../parser.ml"
               : atom))
; (fun __caml_parser_env ->
    ...
    Obj.repr(
# 109 "parser.mly"
                                       ( Apply(Neg, "", String.lowercase _2, _4) )
# 470 "../parser.ml"
               : atom))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 2 : string) in
...
; (fun __caml_parser_env ->
    ...
    Obj.repr(
# 112 "parser.mly"
                                               ( Apply(Pos, String.lowercase _1, String.lowercase _3, _5) )
# 493 "../parser.ml"
               : atom))
; (fun __caml_parser_env ->
    ...
    Obj.repr(
# 113 "parser.mly"
                                     ( Apply(Pos, String.lowercase _1, String.lowercase _3, []) )
# 501 "../parser.ml"
               : atom))
; (fun __caml_parser_env ->
    let _2 = (Parsing.peek_val __caml_parser_env 5 : string) in
    ...
    Obj.repr(
# 114 "parser.mly"
                                                   ( Apply(Neg, String.lowercase _2, String.lowercase _4, _6) )
# 510 "../parser.ml"
               : atom))
; (fun __caml_parser_env ->
    let _2 = (Parsing.peek_val __caml_parser_env 4 : string) in
    ...
    Obj.repr(
# 115 "parser.mly"
                                         ( Apply(Neg, String.lowercase _2, String.lowercase _4, []) )
# 518 "../parser.ml"
               : atom))
; (fun __caml_parser_env ->
